...
export async function boot() {
	...
	console.log('config.get("all").sgscharacters===========',config.get("all").sgscharacters);
	console.log('config.get("hiddenCharacterPack")===========',config.get("hiddenCharacterPack"));
