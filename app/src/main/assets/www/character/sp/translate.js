const translates = {
	...
	newwuniang: "武娘",
	newwuniang_info: "你可以将一张非基本牌当作【杀】使用，然后你可以获得其中一名目标角色的一张牌。若此牌不为基本牌，则你失去1点体力，重置〖镇南〗。",
	newzhennan: "镇南",
	newzhennan_info: "限定技，准备阶段，你可以弃置一张牌，视为使用一张指定至多X名目标的【南蛮入侵】（X为此牌可以指定的最大目标数），然后你本回合堆未受到过此牌伤害的目标角色使用牌无次数限制。",
	newxushen: "许身",
	newxushen_info: "限定技，当你进入濒死状态时，你可以令一名其他角色选择一项：①失去所有技能，获得〖征南〗；②获得〖镇南〗。然后你将体力值回复至1点。",
};
